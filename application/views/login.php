                        ...
                        <div class="row">
                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="<?= base_url() ?>login/getlogin" id="login" enctype="multipart/form-data" class="user">
                                        <div class="form-group">
                                            <input type="text" name="username" id="username" class="form-control form-control-user" id="username" placeholder="Enter Username...">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" id="btnLogin" class="btn btn-dark btn-user btn-block">
                                            Login
                                        </button>
                                        <hr>
