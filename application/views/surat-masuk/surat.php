                ...
                <div class="card-header">
                    ...
                    <span class="float-right">
                        ...
                        ?>
                            ...
                            <a href="<?= base_url() ?>surat/tampil/<?= $key ?>" class="btn btn-warning btn-sm"><i class="fas fa-sync-alt"></i></a>
                        <?php
                        } ?>
                    </span>
                </div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url() ?>surat/hapus/<?= $rows['id_surat'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin untuk menghapus');"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            <?php
                            }
